...
ViClip 是一款轻量级 Windows 桌面效率工具，以悬浮窗形式呈现，关闭后自动驻留系统托盘。集剪切板历史管理、快捷短语、翻译、快捷弹出窗口和图片预览等功能于一体。
...
- **全局快捷键**：可自定义键盘快捷键唤起主窗口，支持 Win 键组合
- **鼠标手势**：`Ctrl + Shift + 右键` 切换主窗口显隐
- **系统托盘**：左键切换窗口，右键展开功能菜单
- **四款主题**：浅色 / 深色 / 深蓝 / 深色实底
- **开机自启**：支持静默启动（--hidden 参数），启动后最小化到托盘
...
| 安装包 | 说明 |
|:---|:---|
| `ViClip_x64-setup.exe` | NSIS 安装包 |
| `ViClip_x64_zh-CN.msi` | MSI 安装包（中文） |
